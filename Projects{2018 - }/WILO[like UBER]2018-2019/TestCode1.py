...
def Again_Reset():
    ee=str(input("Press 1 to try again OR press 2 to reset password: "))
    if ee=='1':
        print(login())
    elif ee=='2':
        f=str(input('Email '))
...
def book_ride():
    ...
    eeeee=int(input("press 1 for options and 0 to resume: "))
    if eeeee==1:
        print(cf,df)
        print("Press 1 For Book Your Ride")
        print("Press 2 For Refer & Earn")
    ...
    print("Enter 1 for S.O.S")
    print('Enter 2 for skipping S.O.S')
    j4=str(input(": "))
    if j4=='1':
        print("Sending Your location to nearest police patrol unit")
