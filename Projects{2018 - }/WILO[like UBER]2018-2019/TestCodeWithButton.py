...
def buttonclick(self):
    ...
    print('Vinayak'.center(50))
    print('8826027591'.center(50))
    ...
    if dd=='1':
        ...
        pass
    def login():
        b=str(input("Do you already have an account. Y/N: "))
        if b=='Y' or b=='y':
            c=str(input('Email: '))
...
root=Tk()
f=Frame(root,height=100,width=150)
f.propagate(0)
f.pack()
b=Button(f,text='My Button', width=20, height=4, bg='green', fg='blue', activebackground='cyan', activeforeground='red')
b.pack()
