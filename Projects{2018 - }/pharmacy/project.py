...
root.configure(width=1500,height=600,bg='gold')
var=-1
...
def deleteitem():
    ...
    f = open(r"database.txt")
    working = open(r"database2.txt", "w")
    
    for line in f:
        if str(e1) not in line:
            working.write(line)
            
    os.remove(r"database.txt")
    os.rename(r"database2.txt", r"database.txt")
...
def lastitem():
    ...
    f4=open("database.txt",'r')

    x=f4.read().splitlines()
    last_line= x[-1]
    num_lines = 0

    f8 = open("database.txt", 'r')
...
label0= Label(root,text="PHARMACY MANAGEMENT SYSTEM ",bg="gold",fg="red",font=("Times", 30))
...
label2=Label(root, text="ENTER ITEM PRICE",bd="2",relief="ridge",height="1",bg="red",fg="white",
             font=("Times", 12),width=25)

entry2= Entry(root, font=("Times", 12))

label3=Label(root, text="ENTER ITEM QUANTITY",bd="2",relief="ridge",bg="red",fg="white",
             font=("Times", 12),width=25)

entry3= Entry(root, font=("Times", 12))

label4=Label(root, text="ENTER ITEM CATEGORY",bd="2",relief="ridge",bg="red",fg="white",
             font=("Times", 12),width=25)

entry4= Entry(root, font=("Times", 12))

label5=Label(root, text="ENTER ITEM DISCOUNT",bg="red",relief="ridge",fg="white",
             font=("Times", 12),width=25)
...
button3= Button(root, text="VIEW FIRST ITEM" , bg="white", fg="black", width =20,
                font=("Times", 12),command=firstitem)

button4= Button(root, text="VIEW NEXT ITEM" , bg="white", fg="black", width =20,
                font=("Times", 12), command=nextitem)

button5= Button(root, text="VIEW PREVIOUS ITEM", bg="white", fg="black", width =20,
                font=("Times", 12),command=previousitem)

button6= Button(root, text="VIEW LAST ITEM", bg="white", fg="black", width =20,
